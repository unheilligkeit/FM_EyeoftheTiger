...
cutText ["In der gleichen zeit", "BLACK IN", 10];
...
_firstshot = [cam1, cam2, target1, 15, 0.3, 0.5, false, 0, 0, 0] execVM "camera_work.sqf";
waitUntil {scriptdone _firstshot};

_zweishot = [target1, target1, target2, 18, 1, 1, true, 0.5, 0, 1.6] execVM "camera_work.sqf";
waitUntil {scriptdone _zweishot};

cutText ["", "BLACK IN", 3];
_dreishot = [cam3, cam3, target3, 16, 1, 1, true, 0.3, 0, 1.6] execVM "camera_work.sqf";
waitUntil {scriptdone _dreishot};

cutText ["", "BLACK IN", 3];
_viershot = [cam5, cam6, target4, 25, 1, 0.5, false, 0, 0, 0] execVM "camera_work.sqf";
waitUntil {scriptdone _viershot};
